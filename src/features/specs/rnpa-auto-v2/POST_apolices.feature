...
# operacao
    ...
    #     Exemplos:
    #         | casoDeTeste | valor        | statusCode | codigo  | mensagem                                                                                                                                                                                                                               | descricao                                    |
    #         | 1           | NOVA APOLICE | 400        | 400.018 | O valor enviado para o campo `operacao` é inválido. Valores aceitos: NOVO_SEGURO, RENOVACAO_PROPRIA, RENOVACAO_CONGENERE, ENDOSSO_SUBSTITUICAO, ENDOSSO_ALTERACAO, ENDOSSO_CANCELAMENTO, ENDOSSO_INCLUSAO_ITEM, ENDOSSO_EXCLUSAO_ITEM. | Com operação em maiúsculo                    |
    #         | 2           | Nova Apólice | 400        | 400.018 | O valor enviado para o campo `operacao` é inválido. Valores aceitos: NOVO_SEGURO, RENOVACAO_PROPRIA, RENOVACAO_CONGENERE, ENDOSSO_SUBSTITUICAO, ENDOSSO_ALTERACAO, ENDOSSO_CANCELAMENTO, ENDOSSO_INCLUSAO_ITEM, ENDOSSO_EXCLUSAO_ITEM. | Com a apólice conforme a descrição da tabela |
    #         # | 4           | string vazia  | 400        | 400.001 | O campo operacao não pode ser nulo ou em branco. | Com string vazia              |
